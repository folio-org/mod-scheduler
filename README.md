...
| KAFKA_TENANT_FILTER_ENTITLEMENT_REFRESH_INTERVAL_SECONDS | 900                                                                  | How often, in seconds, the entitled-tenants cache is fully re-fetched from the entitlement service, correcting any drift from a missed or duplicate entitlement event.                                                                                                                                                                                                                                                                           |
